...
Route::get('/examenes/examen','ExamenController@examen')->name('examen.examen');
    ...
    Route::put('/inscripciones/{inscripcion}/{cu}','InscripcionController@update')->middleware('auth');
    Route::get('/inscripciones/{inscripcion}/borrar/{curso}','InscripcionController@destroy')->middleware('auth');
