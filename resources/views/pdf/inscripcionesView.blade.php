...
<div id="content">
  ...
  <h2 align="center">Reporte de Inscripciones</h2>
  <table class="timecard">
    <thead>
    <tr style="background-color: #f79646; color: #fff; font-size: 18px; font-weight: bold;">
      <td style="border: hidden" id="thid">ID</td>
      <td style="border: hidden" id="thnombre">Fecha de Inscripción</td>
      <td style="border: hidden" id="thcarnet">Alumno</td>
      <td style="border: hidden" id="thcelular">Estado</td>
    </tr>
    </thead>
    <tbody>
    @php
